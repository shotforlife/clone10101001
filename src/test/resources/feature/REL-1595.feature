@ST_4684 @tagtagtag @this_is_story_tag
...
@SC_30920 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30921 @third_scenario_tag
...
@SC_30922 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30923 @fifth_scenario_tag
